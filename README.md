...
1. Clone this repo
2. Run npm start from ftl-assignment to start the Express app
3. Run npm run build from another terminal to start the React app
4. Visit http://localhost:5000/ to check out the app or http://localhost:5000/api/getList to view the JSON object.
